...
int handle_print(const char *fmt, int *j, va_list list, char buffer[], int flags, int width, int precision, int size);
...
long int convert_size_unsgnd(unsigned lon int num, int size);
